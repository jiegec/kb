...
- [AMD Transient Scheduler Attacks (AMD-SB-7029)](https://www.amd.com/en/resources/product-security/bulletin/amd-sb-7029.html)
...
- x86 上，SMEP 在 CR4 寄存器中
- ARMv8 上，这个功能通过 PXN(Privileged eXecute Never) 实现，记录在页表中
