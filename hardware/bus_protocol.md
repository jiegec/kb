...
AXI 有支持缓存一致性协议的扩展：ACE，其内容在 [一致性协议](https://jia.je/kb/hardware/cache_coherence_protocol.html) 中介绍。
...
本文主要讨论前两种，TL-C 的内容在 [一致性协议](https://jia.je/kb/hardware/cache_coherence_protocol.html) 中介绍。
