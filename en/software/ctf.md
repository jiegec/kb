...
glibc 2.34+：[移除了 \_\_malloc_hook](https://github.com/bminor/glibc/commit/1e5a5866cb9541b5231dba3d86c8a1a35d516de9)，无法继续使用该办法。
...
详见 [glibc 内存分配器](https://jia.je/kb/en/software/glibc_allocator.html)。
