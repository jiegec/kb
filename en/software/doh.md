...
1. DNS 格式 POST 版，把 DNS 的请求作为 Payload 传入，设置 `accept: application/dns-message` 和 `content-type: application/dns-message`：
...
1. 此外部分 DoH 服务器还支持 RFC 8484 以外的 [JSON 格式](https://developers.google.com/speed/public-dns/docs/doh/json)：
