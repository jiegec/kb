...
1. Relaxation Oscillator：输出方波或者锯齿波或者三角波时钟信号
...
Pierce oscillator（图源[维基百科](https://en.wikipedia.org/wiki/File:Pierce_oscillator.svg)）
...
晶振与芯片的连接（图源[KSZ9031RNX Datasheet](http://ww1.microchip.com/downloads/en/devicedoc/00002117f.pdf)）
