...
PCIe TLP Data Link Layer 格式（图源 PCIe 3.0 标准）
...
PCIe 交换机和 Root Complex 内部图解（图源 PCIe 3.0 标准）

还有 MindShare 书中的图 3-5:

PCIe 完整拓扑（图源 MineShare PCIe 3.0 书）
...
PCIe Type1 Configuration Space（图源 PCIe 3.0 标准）
...
PCIe 枚举结果（图源 MineShare PCIe 3.0 书）
...
PCIe FLIT 3-Way Interleave ECC 图示（图源 [PCIe 6.0 Verification of FEC and CRC](https://www.synopsys.com/blogs/chip-design/pcie-6-verifaction-fec-crc.html)）
...
PCIe Bifurcation 配置方式（图源 Xeon E5 v4 Datasheet Volume 2）
