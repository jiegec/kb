...
CTLE（图源 \[https://people.engr.tamu.edu/spalermo/ecen689/lecture18_ee689_rx_fir_ctle_eq.pdf\](https://jia.je/kb/en/hardware/RX FIR & CTLE Equalization)）

### FFE Feed-Forward Equalization

在时域数字信号上工作，等价于一个 Finite Impulse Response (FIR)，相当于把一个方波分解成几个小的方波，线性。

FFE（图源 \[https://people.engr.tamu.edu/spalermo/ecen689/lecture18_ee689_rx_fir_ctle_eq.pdf\](https://jia.je/kb/en/hardware/RX FIR & CTLE Equalization)）
...
DFE（图源 \[https://docs.keysight.com/eesofapps/post-8-eye-opening-experience-with-dfe-678068404.html\](https://jia.je/kb/en/hardware/Post 8: Eye-opening Experience with DFE)）

DFE（图源 \[http://www.seas.ucla.edu/brweb/papers/Journals/BRFall17DFE.pdf\](https://jia.je/kb/en/hardware/The Decision-Feedback Equalizer)）
