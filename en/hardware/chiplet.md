...
1. 链路层 Link Layer：可靠传输，链路适配
1. 数字物理层 Digital Physical Layer
...
1. 中间的 Die-to-Die Adapter
1. 底层的 Physical Layer
