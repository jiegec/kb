...
1. Bit11, 10: 协商速率，00 表示 10Mbps，01 表示 100Mbps，11 表示 1000Mbps
1. Bit15:1 表示 Link up，0 表示 Link down
...
1000 BASE-X 的分层（图源 802.3 Clause 36）
...
Xilinx PCS/PMA IP（图源 Xilinx PCS/PMA IP Datasheet）
