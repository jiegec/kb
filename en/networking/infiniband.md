...
IBA 网络结构（图源 InfiniBand Spec）

IBA 架构图（图源 [Infiniband Architectural Overview](https://www.snia.org/sites/default/files/files2/files2/SDC2013/presentations/Hardware/DavidDeming_Infiniband_Architectural_Overview.pdf)）
...
IB Transport Service 对比（图源 InfiniBand Spec）
