...
- 2026/09/24: The Alibaba Cloud Bailian model pricing page added a peak/off-peak time definition to its DeepSeek third-party section (page updated 2026-09-23 23:50): right after the DeepSeek-V4-Flash-0731 peak/off-peak pricing notice and before the model table that lists both peak (忙时) and off-peak (闲时) unit prices, the page now says "busy hours are 08:00–22:00 Beijing time, idle hours are 22:00–08:00 the next day" — i.e. the DeepSeek models in that table whose prices are split into peak/off-peak are charged with 08:00–22:00 as peak and 22:00–08:00 as off-peak each day (the same window as the Bailian Token Plan Personal Edition night discount). No prices or other billing rules changed
- 2026/09/24: OpenCode Go added GPT 6 Luna to its model list: billed in 272K-token tiers — up to 272K tokens input $0.10 / output $0.50 / cache read $0.01 / cache write $0.125 per 1M tokens, above 272K tokens $0.20/$0.75/$0.02/$0.25; the input and cache prices are exactly half of GPT 5.6 Luna's and the output price is lower (was $1.20), while GPT 5.6 Luna stays in both the model list and the pricing table. Monthly usage allowance $15, request limits 4,230 per 5 hours, 10,560 per week, 21,130 per month; model ID `gpt-6-luna`, endpoint https://opencode.ai/zen/go/v1/responses (the data-retention note was updated from "GPT 5.6 Luna" to "GPT 6 Luna / GPT 5.6 Luna")
- 2026/09/23: The Zhipu GLM Coding Plan "GLM-5.3-Flash Usage Campaign" extended its eligible clients from ZCode to ZCode and AutoClaw ([autoclaw.zhipuai.cn](https://autoclaw.zhipuai.cn/)): plan users get unlimited GLM-5.3-Flash usage on both clients, with the campaign period and other terms unchanged (2026-09-03 to 2026-10-07, daily 23:00–09:00; doubled quota on other agents)
- 2026/09/23: OpenCode Go added the limited-time free Space Bunny Free model: input, output and cache read are all Free, with the request limits and monthly usage allowance both listed as unlimited; model ID `space-bunny-free`, endpoint https://opencode.ai/zen/go/v1/chat/completions (the vendor gave no end date for this limited-time promotion)
...
- 2026/09/23: The Volcano Engine deepseek-v4.1-flash limited-time 50%-off deduction window was extended and expanded to the Coding Plan: in the Agent Plan the promotion deadline moved from 2026-09-28 23:59 to 2026-10-30 18:00 (start unchanged at 2026-09-15 00:00, deduction coefficient 2.5 → 1.25), and the Coding Plan added the same promotion for 2026-09-23 00:00 to 2026-10-30 18:00
