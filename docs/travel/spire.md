...
- 主宰（Dominate）：敌人身上每有一层易伤，就获得 1 点力量。消耗。（v0.100.0 版本新增：给予 1 层易伤）
...
- 违逆（Defy）：虚无。获得 6 点格挡。给予 1 层虚弱。（v0.100.0 版本削弱为消耗）
...
- 捕捉灵魂（Capture Spirit）：敌人失去 3 生命。将 3 张灵魂加入你的抽牌堆。（v0.100.0 版本削弱为失去 2 生命，加入 2 张灵魂）
- 预借时间（Borrowed Time）：给予自身 3 层灾厄。获得 1 能量。（v0.100.0 版本削弱为给予自身 6 层灾厄）
